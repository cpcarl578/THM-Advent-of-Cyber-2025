...
1.understand what social engineering is
2.Learn the types of Phishing
3.Explore how red teams create fake login pages
4.Use the Social-Engineer Toolkit to send a phishing email (using the attackbox VM)
...
- Create a fake login profile to exploit using phishing
- use of SET
- 
